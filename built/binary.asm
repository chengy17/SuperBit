...
; Virtual methods: 0 / 0
; generated code sizes (bytes): 2072 (incl. 1366 user, 662 helpers, 12 vtables, 32 lits); src size 0
; assembly: 1350 lines; density: Infinity bytes/stmt; (0 stmts)
; total bytes: 218136 (89.9% of 237.0k flash with 24552 free)
...
; start
    ...
    .hex B1B1474090CC1EB2 ; hex template hash
    .hex 5472BFE93B3D9AFB ; program hash
    .short 1   ; num. globals
